...
def tool():
  ...
  def options1():
    ...
    os.system('cls' if os.name=='nt' else 'clear')
    ctypes.windll.kernel32.SetConsoleTitleW("Nxlqn multi tools <3")
    print(f'''
    ...
    print(Fore.CYAN+     '║     [05] SERVER SPAMMER      ║     [13] MEMBER IDS      ║     [19] HYPEQUAD CHANGER    ║                          ║')
...
{Fore.RED} | |_| | | |_| | | | |_| | |_) |
  ...
  [\>]""")
    ...
    if gh in ['01','1']:
      webbrowser.open('https://github.com/NxlqnYT')
    else:
...
{Fore.RED} | |__| (_) | (_| | | | | |
 ...
 \033[31m| |___| | |  __/ (_| | | |_\__ \ 
  \____|_|  \___|\__,_|_|\__|___/
    ...
    ''')
    By = Fore.LIGHTBLACK_EX + '<3'
    Nxlqn = Fore.MAGENTA + 'Nxlqn#9184'
...
{Fore.RED} | |_| | \__ \ (_| (_) | | | (_| | 
 |____/|_|___/\___\___/|_|  \__,_| 
  ...
  [1] Nxlqn discord (tools)

  [?>]'''))


    if whichserver == 1:
      webbrowser.open('https://discord.gg/ttSnScGm')
    else:
      print("Invalid Option.")
...
{Fore.RED}   | | (_) | |_| || || |_| | |_) |  __/ 
   |_|\___/ \__,_||_| \__,_|_.__/ \___| 
    ...
    ''')
    webbrowser.open('https://www.youtube.com/channel/UCWtKVezhqYXP1q7HkcNvwGA')
